...
const NOTICE_I18N = {
  ...
  desc: {
    'en': 'Our system will be unavailable from 19:00 to 24:00 UTC on August 28 for an upgrade. For questions, kindly contact our support team . We value your patience.',
    'zh-Hans': '为了有效提升数据检索能力及稳定性 将于 2023 年 8 月 29 日 03:00 至 08:00 期间进行服务升级，届时 云端版及应用将无法访问。感谢您的耐心与支持。',
  },
}
