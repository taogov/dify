...
const config: ProviderConfig = {
  ...
  item: {
    ...
    disable: {
      ...
      link: {
        href: {
          'en': 'https://www.gotoai.world/h-col-128.htmlgetting-started/install-self-hosted',
          'zh-Hans': 'https://www.gotoai.world/h-col-128.htmlv/zh-hans/getting-started/install-self-hosted',
        },
        label: {
