const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'GotoAi account',
    langGeniusAccountTip: 'Your GotoAi account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to GotoAi to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by GotoAi allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API-based extensions provide centralized API management, simplifying configuration for easy use across GotoAi\'s applications.',
    link: '',
    linkUrl: '',
  ...
  about: {
    ...
    nowAvailable: 'GotoAi {{version}} is now available.',
    latestAvailable: 'GotoAi {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
