const translation = {
  ...
  desc: 'Here you can moGotoAI the properties and working methods of the Knowledge.',
  form: {
    name: 'Knowledge Name',
    ...
    descPlaceholder: 'Describe what is in this Knowledge. A detailed description allows AI to access the content of the Knowledge in a timely manner. If empty, GotoAI will use the default hit strategy.',
