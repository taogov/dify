const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version of GotoAi with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see GotoAi\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
        },
      },
      embedded: {
        entry: 'Embedded',
        ...
        chromePlugin: 'Install GotoAi Chatbot Chrome Extension',
        copied: 'Copied',
        copy: 'Copy',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          name: 'Fork the client code, moGotoAi it and deploy to Vercel (recommended)',
          step1: 'Fork the client code and moGotoAi it',
          step1Tip: 'Click here to fork the source code into your GitHub account and moGotoAi the code',
          step1Operation: 'GotoAi-WebClient',
