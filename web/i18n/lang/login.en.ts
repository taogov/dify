const translation = {
  ...
  welcome: 'Welcome to GotoAi, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting GotoAi Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on GotoAi',
  invalid: 'The link has expired',
  explore: 'Explore GotoAi',
