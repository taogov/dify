const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title: 'You have switched to Expert Mode, and once you moGotoAi the PROMPT, you CANNOT return to the basic mode.',
  ...
  automatic: {
    ...
    description: 'Describe your scenario, GotoAi will orchestrate an application for you.',
  ...
  formattingChangedText:
    'MoGotoAiing the formatting will reset the debug area, are you sure?',
  ...
  datasetConfig: {
    ...
    retrieveChangeTip: 'MoGotoAiing the index mode and retrieval mode may affect applications associated with this Knowledge.',
  },
}
